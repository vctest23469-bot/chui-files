...
xcrun swiftc -swift-version 5 -target arm64-apple-macos14.0 -O -module-cache-path /tmp/chui-swift-cache Sources/*.swift -o 'build/Chui Files.app/Contents/MacOS/ChuiFiles' -framework SwiftUI -framework AppKit -framework Quartz
